...
#ifndef POINT_TO_POINT_EPC_HELPER_EXT_H
#define POINT_TO_POINT_EPC_HELPER_EXT_H
 ...
 */
class PointToPointEpcHelperExt : public NoBackhaulEpcHelperExt
{
public:
  /**
   * Constructor
   */
  PointToPointEpcHelperExt ();

  /**
   * Destructor
   */
  virtual ~PointToPointEpcHelperExt ();
  ...
  virtual void setIpP2P(std::string s1u, std::string s1ap);
