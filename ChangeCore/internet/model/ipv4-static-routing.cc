...
Ipv4StaticRouting::AddNetworkRouteTo (Ipv4Address network, 
                                      ...
                                      uint32_t metric)
{
  // std::cout<<"Ipv4StaticRouting::AddNetworkRouteTo"<<std::endl;
...
{
  // std::cout<<"Ipv4StaticRouting::RouteOutput"<<std::endl;
  // std::cout<< this << " " << p <<" "<< header <<" "<< oif <<" "<< sockerr <<std::endl;
...
{
  // std::cout<<"Ipv4StaticRouting::RouteInput"<<std::endl;
  // std::cout<<p->ToString()<<std::endl;
  // std::cout<< ipHeader << " " << ipHeader.GetSource () <<" "
  //         << ipHeader.GetDestination () << " " << idev << " " 
  //         << &ucb <<" "<< &mcb <<" "<< &lcb <<" "<< &ecb<<std::endl;
