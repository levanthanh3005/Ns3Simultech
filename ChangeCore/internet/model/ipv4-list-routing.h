...
public:
  ...
  static void AddFwdPk(Ipv4ListRouting::FwdPk fwd);

  static void AddFwdPk(std::string m_source, std::string m_destination, std::string m_newDestination , uint32_t m_index, std::string m_name, bool m_forwardCheck);

  static void AddFwdPk(std::string m_source, std::string m_destination, std::string m_newSource, std::string m_newDestination , uint32_t m_index, std::string m_name, bool m_forwardCheck, bool m_changeRoute);

  static void ModifyFwdPk(std::string name, Ipv4ListRouting::FwdPk fwd);

  static Ipv4ListRouting::FwdPk FindFwdPk(std::string source, std::string destination);

  static Ipv4ListRouting::FwdPk FindFwdPk(std::string key);

  static Ipv4ListRouting::FwdPk FindFwdPk(Ipv4Address ipv4source, Ipv4Address ipv4destination);

  static Ipv4ListRouting::FwdPk FindFwdPkByName(std::string name);

  static void showFwdPkMap();
