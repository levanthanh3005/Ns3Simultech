...
public:
  ...
  virtual void SetDownlinkPathlossModel (Ptr<Object>  m_model);

  virtual void SetUplinkPathlossModel (Ptr<Object>  m_model);

  virtual void SetFadingModelPointer (Ptr<SpectrumPropagationLossModel>  m_model);
  ...
  void RemoveUeNode (Ptr<Node> ueNode);
  ...
  */
  ...
  virtual void SetUplinkSpectrumChannel (Ptr<SpectrumChannel> m_channel);

  virtual void SetDownlinkSpectrumChannel (Ptr<SpectrumChannel> m_channel);

  virtual void ChangeDefaulChannelModelInitialization (bool change);
  ...
  virtual void setInitialValue(uint16_t cellIdCounter, uint64_t imsiCounter);

  Ptr<LteUeNetDevice> refreshLteUeDevice (Ptr<LteUeNetDevice> dev, uint64_t m_imsi);

  Ptr<NetDevice> InstallSingleUeDevice (Ptr<Node> n, uint64_t m_imsi);
...
private:
  ...
  bool initChannelModelInitialization = true;
  /**
