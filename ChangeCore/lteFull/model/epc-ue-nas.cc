...
EpcUeNas::DoDispose ()
{
  ...
  // delete m_bearersToBeActivatedList;
  // delete m_bearersToBeActivatedListForReconnection;
  m_bearersToBeActivatedList.clear();
  m_bearersToBeActivatedListForReconnection.clear();
  // delete m_bearersToBeActivatedList;
  // delete m_bearersToBeActivatedListForReconnection;
}
...
EpcUeNas::Disconnect ()
{
  // std::cout<<"EpcUeNas::Disconnect ()"<<std::endl;
  NS_LOG_FUNCTION (this);
  SwitchToState (OFF);
...
{
  // std::cout<<"EpcUeNas::ActivateEpsBearer::"<<m_state<<" "<<m_bearersToBeActivatedList.size()<<" "<< m_bearersToBeActivatedListForReconnection.size() <<" "<<m_bidCounter <<std::endl;
...
EpcUeNas::SwitchToState (State newState)
{
  ...
  // std::cout<<"EpcUeNas::SwitchToState:: IMSI " << m_imsi << " NAS " << ToString (oldState) << " --> " << ToString (newState)<<std::endl;
