...
LteUeRrcProtocolIdeal::DoSendRrcConnectionRequest (LteRrcSap::RrcConnectionRequest msg)
{
  ...
  // std::cout<<"LteUeRrcProtocolIdeal::DoSendRrcConnectionRequest::"<<m_rrc->GetRnti ()<<std::endl;
...
LteUeRrcProtocolIdeal::SetEnbRrcSapProvider ()
{
  ...
  // std::cout<<"LteUeRrcProtocolIdeal::SetEnbRrcSapProvider::"<< cellId <<std::endl;
...
{
  // std::cout<<"LteEnbRrcProtocolIdeal::DoSendSystemInformation"<<std::endl;
