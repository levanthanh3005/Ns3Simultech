...
{
  // std::cout<<"LteUeMac::RandomlySelectAndSendRaPreamble"<<std::endl;
  NS_LOG_FUNCTION (this);
  // 3GPP 36.321 5.1.1  
...
{
  // std::cout<<"LteUeMac::SendRaPreamble"<<std::endl;
...
{
  // std::cout<<"LteUeMac::RecvRaResponse"<<std::endl;
  NS_LOG_FUNCTION (this);
  m_waitingForRaResponse = false;
...
{
  // std::cout<<"LteUeMac::DoStartContentionBasedRandomAccessProcedure"<<std::endl;
  NS_LOG_FUNCTION (this);
...
{
  // std::cout<<"LteUeMac::DoReceiveLteControlMessage"<<std::endl;
  NS_LOG_FUNCTION (this);
...
{
  // std::cout<<"LteUeMac::SubframeIndication::"<<frameNo<<" "<<subframeNo<<std::endl;
