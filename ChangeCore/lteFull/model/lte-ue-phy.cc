...
LteUePhy::reInit(){
  ...
  m_subframeEvent = Simulator::Schedule (Seconds (GetTti ()), &LteUePhy::SubframeIndication, this, 1, 1);
...
LteUePhy::DoDispose ()
{
  ...
  LtePhy::DoDispose ();
  // std::cout<<"LteUePhy::DoDispose"<<std::endl;
  m_uePhySapUser = 0;

  m_txModeGain.clear ();

  // std::cout<<m_subframeEvent.GetUid()<<std::endl;

  m_subframeEvent.Cancel();
  // m_harqPhyModule = 0;


  // std::cout<<"LteUePhy::DoDispose::1"<<std::endl;

  // Simulator::ScheduleDestroy (&LteUePhy::SubframeIndication);
  // Simulator::ScheduleDestroy (this);
  // m_destroyEvent =
  // Simulator::ScheduleDestroy (&LteUePhy::SubframeIndication, this);
}
...
{
  // std::cout<<"LteUePhy::DoInitialize"<<std::endl;
  NS_LOG_FUNCTION (this);
...
{
  // std::cout<<"LteUePhy::SetLteUePhySapUser"<<std::endl;
  NS_LOG_FUNCTION (this);
  m_uePhySapUser = s;
}
...
{
  // std::cout<<"LteUePhy::ReceiveLteControlMessageList::"<< "" <<std::endl;
  NS_LOG_FUNCTION (this);
  ...
  for (it = msgList.begin (); it != msgList.end (); it++)
    {
      ...
      if (msg->GetMessageType () == LteControlMessage::DL_DCI)
        {
          // std::cout<<"LteUePhy::ReceiveLteControlMessageList::LteControlMessage::DL_DCI"<<std::endl;
...
//             NS_LOG_DEBUG(this << " RNTI " << m_rnti << " RBG " << i << " DL-DCI allocated PRB " << (i*GetRbgSize()) + k);
        ...
        {
          // std::cout<<"LteUePhy::ReceiveLteControlMessageList::LteControlMessage::UL_DCI"<<std::endl;
        ...
        {
          // std::cout<<"LteUePhy::ReceiveLteControlMessageList::LteControlMessage::RAR"<<std::endl;
        ...
        {
          // std::cout<<"LteUePhy::ReceiveLteControlMessageList::LteControlMessage::MIB"<<std::endl;
        ...
        {
          // std::cout<<"LteUePhy::ReceiveLteControlMessageList::LteControlMessage::SIB1"<<std::endl;
        ...
        {
          // std::cout<<"LteUePhy::ReceiveLteControlMessageList::LteControlMessage::Others"<<std::endl;
...
{
  // std::cout<<"LteUePhy::SubframeIndication::"<<m_ulConfigured<<" "<<frameNo<<" "<< subframeNo <<std::endl;
  // std::cout<<this<<std::endl;

  if (!m_uePhySapUser) {
    // Simulator::ScheduleDestroy(&LteUePhy::SubframeIndication);
    // std::cout<<"m_uePhySapUser:0::"<<Simulator::GetEventCount()<<std::endl;
    // Simulator::ScheduleDestroy (&LteUePhy::SubframeIndication, this, frameNo, subframeNo);
    // std::cout<<"m_uePhySapUser:0::"<<Simulator::GetEventCount()<<std::endl;
    return;
  }
  ...
  // std::cout<<"LteUePhy::SubframeIndication::m_uePhySapUser::"<<frameNo<<" "<< subframeNo <<std::endl;
  // std::cout<<"LteUePhy::SubframeIndication::"<<m_uePhySapUser <<std::endl;
  // trigger the MAC

  m_uePhySapUser->SubframeIndication (frameNo, subframeNo);

  // std::cout<<"LteUePhy::SubframeIndication::m_uePhySapUser 2::"<<frameNo<<" "<< subframeNo <<std::endl;
  ...
  // std::cout<<"LteUePhy::SubframeIndication::Schedule::"<<frameNo<<" "<< subframeNo <<std::endl;
...
LteUePhy::DoSynchronizeWithEnb (uint16_t cellId, uint32_t dlEarfcn)
{
  ...
  // std::cout<<"LteUePhy::DoSynchronizeWithEnb::"<< cellId  <<" "<< dlEarfcn <<std::endl;
  m_dlEarfcn = dlEarfcn;
