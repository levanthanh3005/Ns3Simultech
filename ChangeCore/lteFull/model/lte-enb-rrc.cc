...
{
  // std::cout<<"UeManager::DoInitialize"<<std::endl;
  NS_LOG_FUNCTION (this);
...
{
  // std::cout<<"UeManager::SetImsi"<<std::endl;
  m_imsi = imsi;
}
...
{
  // std::cout<<"UeManager::InitialContextSetupRequest:"<< m_state <<std::endl;
...
{
  // std::cout<<"LteEnbRrc::DoSendReleaseDataRadioBearer::"<<imsi<<" "<< rnti<<" "<<bearerId<<std::endl;
  ...
  if (HasUeManager(rnti)){
    ...
    // std::cout<<"LteEnbRrc::DoSendReleaseDataRadioBearer::Has UeManager"<<std::endl;

  } else {
    // std::cout<<"LteEnbRrc::DoSendReleaseDataRadioBearer::No UeManager"<<std::endl;
  }
...
{
  // std::cout<<"UeManager::SendData"<<std::endl;
  NS_LOG_FUNCTION (this << p << (uint16_t) bid);
  switch (m_state)
    {
    case INITIAL_RANDOM_ACCESS:
...
{
  // std::cout<<"UeManager::RecvRrcConnectionSetupCompleted"<<std::endl;
...
{
  // std::cout<<"LteEnbRrc::SendData"<<std::endl;
...
{
  // std::cout<<"LteEnbRrc::ConnectionRequestTimeout"<<std::endl;
...
{
  // std::cout<<"LteEnbRrc::HandoverJoiningTimeout"<<std::endl;
...
{
  // std::cout<<"LteEnbRrc::HandoverLeavingTimeout"<<std::endl;
  NS_LOG_FUNCTION (this << rnti);
...
{
  // std::cout<<"LteEnbRrc::SendHandoverRequest"<<std::endl;
...
{
  // std::cout<<"LteEnbRrc::DoCompleteSetupUe"<<std::endl;
  NS_LOG_FUNCTION (this << rnti);
...
{
  // std::cout<<"LteEnbRrc::DoRecvRrcConnectionRequest"<<std::endl;
  NS_LOG_FUNCTION (this << rnti);
...
{
  // std::cout<<"LteEnbRrc::DoRecvRrcConnectionReconfigurationCompleted"<<std::endl;
  NS_LOG_FUNCTION (this << rnti);
...
{
  // std::cout<<"LteEnbRrc::DoRecvRrcConnectionReestablishmentRequest"<<std::endl;
  NS_LOG_FUNCTION (this << rnti);
...
{  
  // std::cout<<"LteEnbRrc::DoRecvRrcConnectionReestablishmentComplete"<<std::endl;
  NS_LOG_FUNCTION (this << rnti);
...
LteEnbRrc::DoRecvMeasurementReport (uint16_t rnti, LteRrcSap::MeasurementReport msg)
{
  ...
  // std::cout<<"LteEnbRrc::DoRecvMeasurementReport"<<std::endl;

  NS_LOG_FUNCTION (this << rnti);
  if (HasUeManager(rnti)){
    GetUeManager (rnti)->RecvMeasurementReport (msg);
  } else {
    // std::cout<<"LteEnbRrc::DoRecvMeasurementReport: rnti not exists"<<std::endl;
  }
}
...
{
  // std::cout<<"LteEnbRrc::DoInitialContextSetupRequest"<<std::endl;
  NS_LOG_FUNCTION (this);
...
{
  // std::cout<<"LteEnbRrc::DoRecvIdealUeContextRemoveRequest"<<std::endl;
  ...
  if (HasUeManager(rnti)){
    ...
    // std::cout<<"LteEnbRrc::DoRecvIdealUeContextRemoveRequest: rnti not exists"<<std::endl;
  }
}
...
{
  // std::cout<<"LteEnbRrc::DoDataRadioBearerSetupRequest"<<std::endl;
...
{
  // std::cout<<"LteEnbRrc::DoPathSwitchRequestAcknowledge"<<std::endl;
  NS_LOG_FUNCTION (this);
...
LteEnbRrc::DoRecvHandoverRequestAck (EpcX2SapUser::HandoverRequestAckParams params)
{
  ...
  // std::cout<<"LteEnbRrc::DoRecvHandoverRequestAck"<<std::endl;
...
{
  // std::cout<<"LteEnbRrc::DoRecvHandoverPreparationFailure"<<std::endl;
...
{
  // std::cout<<"LteEnbRrc::DoRecvSnStatusTransfer"<<std::endl;
  NS_LOG_FUNCTION (this);
...
LteEnbRrc::DoRecvUeData (EpcX2SapUser::UeDataParams params)
{
  ...
  // std::cout<<"LteEnbRrc::DoRecvUeData"<<std::endl;
...
{
  // std::cout<<"LteEnbRrc::DoAllocateTemporaryCellRnti"<<std::endl;
  NS_LOG_FUNCTION (this << +componentCarrierId);
...
LteEnbRrc::DoRrcConfigurationUpdateInd (LteEnbCmacSapUser::UeConfig cmacParams)
{
  ...
  // std::cout<<"LteEnbRrc::DoRrcConfigurationUpdateInd"<<std::endl;
...
LteEnbRrc::DoTriggerHandover (uint16_t rnti, uint16_t targetCellId)
{
  ...
  // std::cout<<"LteEnbRrc::DoTriggerHandover"<<std::endl;
...
LteEnbRrc::DoSetPdschConfigDedicated (uint16_t rnti, LteRrcSap::PdschConfigDedicated pdschConfigDedicated)
{
  ...
  // std::cout<<"LteEnbRrc::DoSetPdschConfigDedicated"<<std::endl;
...
{
  // std::cout<<"LteEnbRrc::AddUe"<<std::endl;
  NS_LOG_FUNCTION (this);
  bool found = false;
  uint16_t rnti;
...
{
  // std::cout<<"LteEnbRrc::IsRandomAccessCompleted"<<std::endl;
