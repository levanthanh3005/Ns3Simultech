...
{
  // std::cout<<"LteSpectrumPhy::StartRx::"<<m_state<<" "<<m_cellId<<std::endl;
...
{
  // std::cout<<"LteSpectrumPhy::StartRxData"<<std::endl;
  NS_LOG_FUNCTION (this);
  switch (m_state)
    {
      case TX_DATA:
...
LteSpectrumPhy::StartRxDlCtrl (Ptr<LteSpectrumSignalParametersDlCtrlFrame> lteDlCtrlRxParams)
{
  ...
  // std::cout<<"LteSpectrumPhy::StartRxDlCtrl::"<<cellId<< " vs "<<m_cellId<<std::endl;
          ...
          if (cellId  == m_cellId)
          ...
          else
            {
              NS_LOG_LOGIC (this << " not synchronizing with this signal (cellId=" 
                            << cellId  << ", m_cellId=" << m_cellId << ")");          
              // std::cout<< "LteSpectrumPhy:: not synchronizing with this signal (cellId=" 
              //               << cellId  << ", m_cellId=" << m_cellId << ")"<<std::endl;
            }
          break;
...
{
  // std::cout<<"LteSpectrumPhy::StartRxUlSrs"<<std::endl;
...
{
  // std::cout<<"LteSpectrumPhy::EndRxData"<<std::endl;
  NS_LOG_FUNCTION (this);
  NS_LOG_LOGIC (this << " state: " << m_state);
...
{
  // std::cout<<"LteSpectrumPhy::SetCellId::"<< cellId <<std::endl;
  m_cellId = cellId;
}
